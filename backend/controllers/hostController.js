...
exports.createHostedTrip = async (req, res, next) => {
  ...
  const {pickupCity, exactPickup, exactDrop, dropCity, seatFare, kmRate, date, model, number, type, seats} = req.body
  const hostedTrip = new HostedTrip({pickupCity, exactPickup, exactDrop, dropCity, seatFare, kmRate, date, model, number, type, seats})
