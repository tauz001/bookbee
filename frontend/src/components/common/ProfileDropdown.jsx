...
const ProfileDropdown = ({ isOpen, onClose, user, onLogout }) => {
  ...
  return (
    <>
      ...
      {/* Dropdown */}
      <div className="absolute right-0 mt-2 w-64 z-20 transform transition-all duration-200 ease-in-out">
          ...
          <div className="px-6 py-4 bg-gradient-to-r from-yellow-500 to-yellow-600">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-yellow-100 text-xs">{user?.mobile}</p>
              </div>
            </div>
          </div>
              ...
              >
                <path
                  ...
                  d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 
                    0 4.847.655 6.879 1.804M15 10a3 3 
                    0 11-6 0 3 3 0 016 0zm6 2a9 9 
